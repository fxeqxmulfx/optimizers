...
const WEIERSTRASS_BK_PI: [Vec8; 27] = [
    Vec8::splat(3.141592653589793),
    Vec8::splat(21.991148575128552),
    Vec8::splat(153.93804002589985),
    Vec8::splat(1077.5662801812991),
    Vec8::splat(7542.9639612690935),
    Vec8::splat(52800.74772888365),
    Vec8::splat(369605.2341021856),
    Vec8::splat(2587236.638715299),
    Vec8::splat(18110656.471007094),
    Vec8::splat(126774604.72182761),
    Vec8::splat(887422201.6368667),
    Vec8::splat(6211955034.4669485),
    Vec8::splat(43483685555.42791),
    Vec8::splat(304385802029.588),
    Vec8::splat(2130700708454.8955),
    Vec8::splat(14914904330865.738),
    Vec8::splat(104404328745263.84),
    Vec8::splat(730830301216846.9),
    Vec8::splat(5115812202765708.0),
    Vec8::splat(3.5810684791041424e+16),
    Vec8::splat(2.5067477782932672e+17),
    Vec8::splat(1.754723570468993e+18),
    Vec8::splat(1.2283064930451098e+19),
    Vec8::splat(8.598145451315769e+19),
    Vec8::splat(6.018701847336965e+20),
    Vec8::splat(4.213091575879214e+21),
    Vec8::splat(2.9491639460358173e+22),
];
