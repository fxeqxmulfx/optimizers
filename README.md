...
| 128  | 2816  | **2272**  | 2816  | 5632  | 3968  | 2176  | 2669 |
| 256  | 4352  | **3456**  | 4352  | 10112 | 6272  | 3264  | 5340 |
| 512  | 6976  | **5312**  | 6976  | 16864 | 10048 | 5376  | 10689 |
| 1024 | 12288 | **9024**  | 12288 | 23776 | 16832 | --- | 21350 |

ANS Sort is 20--27% faster than ANS/ANSR on easy functions at every dimension, with 100% success rate. The sorted archive concentrates search around the best known solutions, accelerating convergence on unimodal landscapes.

#### Medium Terrain (64--256D, maxiter=500k)

| Dim | Func | ANS | ANS Sort | ANSR | DPNM | DE | SHADE |
| --- | ---- | --- | -------- | ---- | ---- | -- | ----- |
| 64 | hilly  | inf | 402k (84.5%) | inf | inf | inf | inf |
| 64 | forest | 47.3k | 335k | 47.3k | 47.1k | inf | inf |
| 128 | hilly  | inf | --- | inf | inf | inf | --- |
| 128 | forest | 101k | --- | 73.1k | 70.4k | 86.2k | inf |
| 256 | hilly  | inf | --- | inf | --- | inf | --- |
| 256 | forest | 175k | --- | 209k | --- | 129k | inf |

ANS Sort fails at 128D and above on terrain functions. At 64D it converges but is much slower than ANS (335k vs 47k on forest). The sorted archive causes premature convergence on multimodal landscapes.

#### Medium Periodic: Shubert (16--64D, maxiter=500k)

| Dim | ANS | ANS Sort | ANSR | DPNM | DE | SHADE |
| --- | --- | -------- | ---- | ---- | -- | ----- |
| 16 | 13.8k (98%) | **6.6k (88%)** | 10.4k (100%) | 123k (100%) | 16.6k (100%) | 40.8k (100%) |
| 32 | 44.7k (87%) | **32.7k (91%)** | 27.9k (100%) | 401k (100%) | 37.5k (100%) | 102k (100%) |
| 64 | 187k (77.5%) | --- (0%) | **61.6k (100%)** | --- (0%) | 81.7k (100%) | 245k (100%) |

ANS Sort is fastest at 16D and 32D but has lower success rates than ANSR. At 64D it fails entirely, similar to DPNM. Without restarts, the sorted archive concentrates the population but cannot escape local optima at higher dimensions.
...
DE is the only reliable solver. ANS Sort, ANSR, DPNM, and ZG achieve 0% at all dimensions. ANS achieves 73% at 16D only.
